...
<html class=" js flexbox canvas canvastext webgl no-touch geolocation postmessage websqldatabase indexeddb hashchange history draganddrop websockets rgba hsla multiplebgs backgroundsize borderimage borderradius boxshadow textshadow opacity cssanimations csscolumns cssgradients cssreflections csstransforms csstransforms3d csstransitions fontface generatedcontent video audio localstorage sessionstorage webworkers applicationcache svg inlinesvg smil svgclippaths"><!--<![endif]--><head>
  ...
  <!-- 
	...
	<body class="fh5co-overflow offcanvas-visible"><a href="#" class="js-fh5co-nav-toggle fh5co-nav-toggle active"><i></i></a><div id="fh5co-offcanvas"><a href="#" data-nav-section="home" class="">Home</a><a href="#" data-nav-section="about" class="">About</a><a href="#" data-nav-section="features" class="active">Features</a><a href="#" data-nav-section="menu">Menu</a><a href="#" data-nav-section="events">Events</a><a href="#" data-nav-section="reservation">Reservation</a></div>

	<div id="fh5co-container">
		<div id="fh5co-home" class="js-fullheight animated" data-section="home" style="height: 854px;">

			<div class="flexslider">
				
				<div class="fh5co-overlay" style="opacity: 2.6895;"></div>
				<div class="fh5co-text" style="opacity: -13.5967; margin-top: 4167px; display: none;">
					<div class="container">
						<div class="row">
							<h1 class="to-animate fadeInUp animated">foodee</h1>
							<h2 class="to-animate fadeInUp animated">Lovely Designed <span>by</span> <a href="http://freehtml5.co/" target="_blank">freehtml5.co</a></h2>
						</div>
					</div>
				</div>
			  	<ul class="slides">
			   	<li style="background-image: url(&quot;images/slide_1.jpg&quot;); width: 100%; float: left; margin-right: -100%; position: relative; opacity: 1; display: block; z-index: 2; height: 854px; background-position: 0px 2189.5px;" data-stellar-background-ratio="0.5" class="flex-active-slide" data-thumb-alt=""></li>
			   	<li style="background-image: url(&quot;images/slide_2.jpg&quot;); width: 100%; float: left; margin-right: -100%; position: relative; opacity: 0; display: block; z-index: 1; height: 854px; background-position: 0px 2189.5px;" data-stellar-background-ratio="0.5" data-thumb-alt="" class=""></li>
			   	<li style="background-image: url(&quot;images/slide_3.jpg&quot;); width: 100%; float: left; margin-right: -100%; position: relative; opacity: 0; display: block; z-index: 1; height: 854px; background-position: 0px 2189.5px;" data-stellar-background-ratio="0.5" data-thumb-alt="" class=""></li>
			  	</ul>
			...
			<div class="fh5co-main-nav">
				<div class="container-fluid">
					<div class="fh5co-menu-1">
						<a href="#" data-nav-section="home" class="">Home</a>
						<a href="#" data-nav-section="about" class="">About</a>
						<a href="#" data-nav-section="features" class="active">Features</a>
					</div>
		...
		<div id="fh5co-sayings" class="animated">
			<div class="container">
				<div class="row to-animate fadeInUp animated">

					<div class="flexslider">
						
					<div class="flex-viewport" style="overflow: hidden; position: relative; height: 137px;"><ul class="slides" style="width: 1200%; transition-duration: 0.6s; transform: translate3d(-728px, 0px, 0px);"><li class="clone" aria-hidden="true" style="width: 728px; margin-right: 0px; float: left; display: block;">
								<blockquote>
							...
							</li><li class="" data-thumb-alt="" style="width: 728px; margin-right: 0px; float: left; display: block;">
								<blockquote>
							...
							</li><li data-thumb-alt="" class="" style="width: 728px; margin-right: 0px; float: left; display: block;">
								<blockquote>
									<p>“Find something you’re passionate about and keep tremendously interested in it.”</p>
									<p class="quote-author">— Julia Child</p>
								</blockquote>
							</li><li data-thumb-alt="" style="width: 728px; margin-right: 0px; float: left; display: block;" class="">
								<blockquote>
							...
							</li><li data-thumb-alt="" style="width: 728px; margin-right: 0px; float: left; display: block;" class="flex-active-slide">
								<blockquote>
									<p>“Cooking is an art, but all art requires knowing something about the techniques and materials”</p>
									<p class="quote-author">— Nathan Myhrvold</p>
								</blockquote>
							</li><li class="clone" aria-hidden="true" style="width: 728px; margin-right: 0px; float: left; display: block;">
								<blockquote>
									<p>“Never work before breakfast; if you have to work before breakfast, eat your breakfast first.”</p>
									<p class="quote-author">— Josh Billings</p>
								</blockquote>
							</li></ul></div><ol class="flex-control-nav flex-control-paging"><li><a href="#" class="">1</a></li><li><a href="#" class="">2</a></li><li><a href="#" class="">3</a></li><li><a href="#" class="flex-active">4</a></li></ol></div>

				</div>
			</div>
		</div>

		<div id="fh5co-featured" data-section="features" class="animated">
			<div class="container">
				<div class="row text-center fh5co-heading row-padded">
					<div class="col-md-8 col-md-offset-2">
						<h2 class="heading to-animate fadeInUp animated">Featured Dishes</h2>
						<p class="sub-heading to-animate fadeInUp animated">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
					</div>
				</div>
				<div class="row">
		...
		<div id="fh5co-type" style="background-image: url(&quot;images/slide_3.jpg&quot;); background-position: 0px -360px;" data-stellar-background-ratio="0.5">
		...
		<div id="fh5co-events" data-section="events" style="background-image: url(&quot;images/slide_2.jpg&quot;); background-position: 0px 837.656px;" data-stellar-background-ratio="0.5">
			<div class="fh5co-overlay"></div>
			<div class="container">
				<div class="row text-center fh5co-heading row-padded">
		...
		<div class="container">
			<div class="row row-padded">
				<div class="col-md-12 text-center">
					<p class="to-animate">© 2016 Foodee Free HTML5 Template. <br> Designed by <a href="http://freehtml5.co/" target="_blank">FREEHTML5.co</a> Demo Images: <a href="http://pexels.com/" target="_blank">Pexels</a> <br> Tasty Icons Free <a href="http://handdrawngoods.com/store/tasty-icons-free-food-icons/" target="_blank">handdrawngoods</a>
					</p>

     ...
     //   console.log(that);
        ...
        if ($('.carouselGallery-wrapper').length === 0) {
            if(typeof imagepath !== 'undefined') {
                ...
                modalHtml += "<img id='img' src='"+imagepath+"' alt='carouselGallery image'>";
                modalHtml += "</div>";
                ...
                modalHtml += "<p id='boardContent'>"+imagetext+"</p>";
                modalHtml += "</span>";
                modalHtml += "<span class=''>";
                modalHtml += "<p><button id='update' class='btn-default'>수정</button><button id='delete' class='btn-default'>삭제</button></p>";
                modalHtml += "<p id='boardNo'>" + no + "</p>";
